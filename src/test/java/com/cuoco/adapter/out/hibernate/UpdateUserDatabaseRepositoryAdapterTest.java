...
//    @Mock
//    private GetUserByEmailHibernateRepositoryAdapter getUserByEmailHibernateRepositoryAdapter;
//    @Mock
//    private GetUserPreferencesByUserIdHibernateRepositoryAdapter getUserPreferencesByUserIdHibernateRepositoryAdapter;
//    @Mock
...
//                getUserByEmailHibernateRepositoryAdapter,
...
//
//        when(getUserByEmailHibernateRepositoryAdapter.findByEmail("test@example.com"))
...
//        verify(getUserByEmailHibernateRepositoryAdapter, times(1)).findByEmail("test@example.com");
...
//
//        when(getUserByEmailHibernateRepositoryAdapter.findByEmail("notfound@example.com"))
...
//        verify(getUserByEmailHibernateRepositoryAdapter, times(1)).findByEmail("notfound@example.com");
